...
// these are the per resource graphql queries
export type NounGql = {
  create: string;
  createMany: string;
  getList: string;
...
export interface ResourceProvider<
  $Resource extends BaseRecord = BaseRecord,
  $ResourceUncheckedCreateInput extends AnyVariables = AnyVariables, // createOne
  ...
  $ResourceWhereUniqueInput extends AnyVariables = AnyVariables // deleteOne
> {
  // Create methods
  create: <
    TData extends BaseRecord = $Resource,
    TVariables extends AnyVariables = $ResourceUncheckedCreateInput
  >(params: {
    client: Client;
    variables: TVariables;
    metaData?: MetaDataQuery;
  ...
  createMany?: <
    TData extends BaseRecord = $Resource,
    TVariables extends AnyVariables = $ResourceCreateManyInput
  >(params: {
    client: Client;
    variables: TVariables;
    metaData?: MetaDataQuery;
  ...
  update: <
    TData extends BaseRecord = $Resource,
    TVariables extends AnyVariables = $ResourceUncheckedUpdateInput
  >(params: {
    client: Client;
    id: BaseKey;
    variables: TVariables;
  ...
  updateMany?: <
    TData extends BaseRecord = $Resource,
    TVariables extends AnyVariables = $ResourceUncheckedUpdateManyInput
  >(params: {
    client: Client;
    ids: BaseKey[];
    variables: TVariables;
  ...
  deleteOne: <
    TData extends BaseRecord = $Resource,
    TVariables = $ResourceWhereUniqueInput
  >(params: {
    client: Client;
    variables: TVariables;
    metaData?: MetaDataQuery;
